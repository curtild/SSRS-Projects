...
- #### A SQL view is created to pull specific purchase orders. Purchase order numbers '0637' and '0925'. (<a href="/PurchaseOrders/v_PurchaseOrderDetail.sql"><em>v_PurchaseOrderDetail.sql</em></a> script is provided to create the view.)
 - #### Embedded data sets <a href="/EmployeeAnniversaries/rsd_PurchaseOrders.rsd"><em>rsd_PurchaseOrders.rsd</em></a> is created to pull data from the view. (SQL file <a href="rsd_PurchaseOrders.sql"><em>rsd_PurchaseOrders.sql</em> is provided to show the SQL for the data set.)
...
#### View Sample Report: <a href="/PurchaseOrders/PurchaseOrders.pdf" height=750 width=550/>PurchaseOrders.pdf</a>
