...
#### You'll also need to adjust the report to include your own entry for your SSRS server. Please create a shared data source named srds_AdventureWorks2017.rds to make the report run out of the box, or create your own data source and update your report definition.
